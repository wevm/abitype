...
test('formatAbiParameter', () => {
    ...
    expectTypeOf(formatAbiParameter({
        type: 'tuple',
        components: [{ type: 'string' }, {
            type: 'tuple',
            components: [{ type: 'string' }, {
    ...
    })).toEqualTypeOf<"(string, (string, (string, (string, (string, (string, (string, (string, (string, (string, (string, (string, (string, (string, (string, (string, (string, (string, Recursion limit hit. Components property has to many nested members.))))))))))))))))))">()
